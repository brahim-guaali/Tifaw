...
Tifaw -- meaning "clarity" or "radiance" in Tamazight (Amazigh/Berber) -- is a local AI desktop assistant and smart file organizer powered by Google's Gemma 4 E4B model running entirely on your machine through Ollama. No cloud, no telemetry, no subscriptions.
